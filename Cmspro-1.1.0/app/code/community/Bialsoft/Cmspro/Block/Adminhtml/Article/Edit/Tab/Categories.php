 ...
 */
class Bialsoft_Cmspro_Block_Adminhtml_Article_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('bialsoft_cmspro/article/edit/tab/categories.phtml');
     ...
     * Returns root node
     *
     * @param Bialsoft_Cmspro_Model_Category|null $parentNodeCategory
