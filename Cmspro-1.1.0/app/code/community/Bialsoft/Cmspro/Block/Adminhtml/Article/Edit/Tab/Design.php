 ...
 */
class Bialsoft_Cmspro_Block_Adminhtml_Article_Edit_Tab_Design extends Mage_Adminhtml_Block_Widget_Form
{
     ...
     *
     * @access protected
     * @return Bialsoft_Cmspro_Block_Adminhtml_Article_Edit_Tab_Meta
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('root_template', 'select',
            ...
            'value' => Mage::getStoreConfig('bialsoft_cmspro/article/default_root_template'),
        ));
