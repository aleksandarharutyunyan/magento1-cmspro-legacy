 ...
 */
class Bialsoft_Cmspro_Model_Resource_Article_Comment_Article_Collection extends Bialsoft_Cmspro_Model_Resource_Article_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('bialsoft_cmspro/article_comment_store');
    }
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('bialsoft_cmspro/article_comment');
        $this->getSelect()->join(
